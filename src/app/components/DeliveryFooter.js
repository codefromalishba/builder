  ...
  return (
    <>
      <div className=" grid grid-cols-4  h-[80px]">
        <div className=" flex justify-between bg-white gap-4 col-span-3 pt-4 pb-4 px-20">
          ...
          {cloudEnabled && (
            <>
              ...
              <div className="flex flex-col gap-2 px-2 justify-start ">
                <p className="text-xs">Cloud Service Cost</p>
                <p className="font-extrabold text-xl">
                  {cloudCost.toFixed(0)} $
                </p>
              </div>
          ...
          <div className="flex flex-col gap-2 px-2 justify-start ">
            ...
            <p className="font-extrabold text-xl">{displayTotalCost} $</p>
          </div>
          {/* {cloudEnabled && (
            <p className="text-sm text-gray-600">
              + Cloud Service: ${cloudCost}
            </p>
          )} */}
